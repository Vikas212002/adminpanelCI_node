...
<div class="container mt-4">
  <h2 class="my-4 text-center text-dark">Summarized Hourly Report <a href="<?= site_url('/download/summary_report?flag=') . $repnum ?>" class="btn btn-primary float-end">Download CSV</a> </h2>
